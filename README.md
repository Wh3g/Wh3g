...
| [Booking System API]([https://github.com/Wh3g/oh_hell_scorer.git](https://github.com/Wh3g/haircut_booking.git)) | Java, Spring Boot | An API for a booking application where users can save their details and make bookings that are saved in a database |
